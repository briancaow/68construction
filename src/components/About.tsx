  ...
  return (
    <div className="flex flex-col justify-start space-y-4 items-center py-20 px-4">
      ...
      <div className="max-w-[1200px] flex flex-col lg:flex-row justify-start space-y-4 items-center lg:items-start lg:px-4">
        ...
        />
        <p className="lg:px-4">
          Welcome to 68Construction, where craftsmanship, integrity, and
          excellence are not just words, but the very foundation of our work.
          I&apos;m Henry, and I founded this company in Renton with a passion
          for building and a commitment to delivering exceptional construction
          ...
          the best of both worlds. We firmly believe that integrity is the
          cornerstone of any successful project. When you choose us, you&apos;re
          not just hiring a construction company; you&apos;re welcoming a
          partner who values your dreams and projects as much as you do. We are
          committed to open communication, transparency, and delivering on our
