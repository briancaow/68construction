...
export default function About() {
  return (
    <div className="flex flex-col justify-start items-center px-4 space-y-4">
      ...
      <div className="max-w-[1000px] flex flex-col justify-center space-y-4 p-3 items-center lg:px-4">
      ...
      <div className="max-w-[1000px] flex flex-col justify-center space-y-4 p-3 items-center lg:px-4">
        <h2 className="text-3xl md:text-4xl lg:text-5xl">What Makes Us The Best</h2>
        <p className="lg:px-4 text-xl">
          68 Construction & Mechanical is driven by a passion for delivering exceptional results. We believe in building strong relationships with our clients, based on trust and mutual respect. Our team of skilled professionals is committed to providing superior craftsmanship and meticulous attention to detail in every project we undertake. We are not just building structures; we are building lasting relationships and creating spaces that our clients will cherish for years to come. We are proud of our work and stand behind our commitment to quality. Building trust with our clients is paramount, and we achieve this through consistent and proactive communication. We conduct weekly check-ins, whether by phone call, FaceTime, or in-person walkthroughs, to keep our clients fully informed of the project&apos;s progress. These regular updates provide a constant feedback loop, allowing us to address any questions or concerns promptly and ensure that the final result aligns perfectly with the client&apos;s vision. This collaborative approach minimizes guesswork and ensures that our clients get exactly what they want. When you choose 68 Construction & Mechanical, you&apos;re choosing a partner dedicated to making your construction vision a reality.
        </p>
      </div>
